            ...
            @csrf
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="email" type="email" name="email" value="" required autofocus class="form-control pl-15 bg-transparent text-white plc-white">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="password" type="password" value="" name="password" required autocomplete="current-password" class="form-control pl-15 bg-transparent text-white plc-white">
									</div>
								</div>
								  <div class="row">
									<div class="col-6">
